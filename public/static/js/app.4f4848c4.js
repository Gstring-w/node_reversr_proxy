  ...
  ["app"],
  {
        ...
        l = {
          watch: {
            $route: function(e) {
              "mobile" === this.device &&
                this.sidebar.opened &&
                r.a.dispatch("closeSideBar", { withoutAnimation: !1 });
            }
          },
          ...
          mounted: function() {
            this.isMobile() &&
              (r.a.dispatch("toggleDevice", "mobile"),
              r.a.dispatch("closeSideBar", { withoutAnimation: !0 }));
          },
          methods: {
            isMobile: function() {
              return c.getBoundingClientRect().width - 3 < 1024;
            },
            resizeHandler: function() {
              if (!document.hidden) {
                var e = this.isMobile();
                r.a.dispatch("toggleDevice", e ? "mobile" : "desktop"),
                  e && r.a.dispatch("closeSideBar", { withoutAnimation: !0 });
              }
            }
          }
        },
    ...
    "6cqe": function(e, t, n) {
      ...
      var i = n("QbLZ"),
        ...
        d = {
          name: "SidebarItem",
          components: { Item: l.default, AppLink: u.default },
          mixins: [
            {
              computed: {
                device: function() {
          ...
          methods: {
            hasOneShowingChild: function(e, t) {
              var n = this,
                i = e.filter(function(e) {
                  return !e.hidden && ((n.onlyOneChild = e), !0);
                });
              return (
                1 === i.length ||
                (0 === i.length &&
                  ((this.onlyOneChild = a()({}, t, {
                    path: "",
                    noShowingChildren: !0
                  })),
                  !0))
            ...
            resolvePath: function(e) {
              return this.isExternalLink(e) ? e : s.a.resolve(this.basePath, e);
            },
        ...
        m = Object(h.a)(
          ...
          function() {
            var e = this,
              t = e.$createElement,
              n = e._self._c || t;
            return !e.item.hidden && e.item.children
              ? n(
                  "div",
                  ...
                  [
                    ...
                    e.item.alwaysShow
                      ? n(
                          ...
                          {
                            ref: "submenu",
                            attrs: { index: e.resolvePath(e.item.path) }
                          },
                          [
                            n(
                              "template",
      ...
      m.options.__file = "SidebarItem.vue";
      t.default = m.exports;
    },
    "6xvN": function(e, t, n) {
      "use strict";
      ...
      function l(e) {
        ...
        return (
          a()(e).forEach(function(n) {
            e[n] && "object" === s()(e[n]) ? (t[n] = l(e[n])) : (t[n] = e[n]);
          }),
          t
        );
      }
    ...
    Gkfo: function(e, t, n) {
          ...
          methods: {
            handleScroll: function(e) {
              var t = e.wheelDelta || 40 * -e.deltaY,
                n = this.$refs.scrollContainer.$refs.wrap;
              n.scrollLeft = n.scrollLeft + t / 4;
            },
            moveToTarget: function(e) {
              var t = this.$refs.scrollContainer.$el.offsetWidth,
                n = this.$refs.scrollContainer.$refs.wrap,
                ...
                s = null,
                r = null;
              i.length > 0 && ((a = i[0]), (o = i[i.length - 1]));
              for (var c = 0; c < i.length; c++)
                if (i[c] === e) {
                  0 === c
                    ? (r = i[c].length > 1 && i[c + 1])
                    : c === i.length - 1
                    ? (s = i[c].length > 1 && i[c - 1])
                    : ((s = i[c - 1]), (r = i[c + 1]));
                  break;
                }
              if (a === e) n.scrollLeft = 0;
              else if (o === e) n.scrollLeft = n.scrollWidth - t;
              else {
                var l = r.$el.offsetLeft + r.$el.offsetWidth + 4,
                  u = s.$el.offsetLeft - 4;
                l > n.scrollLeft + t
                  ? (n.scrollLeft = l - t)
                  : u < n.scrollLeft && (n.scrollLeft = u);
              }
            }
          }
        },
      ...
      var c = {
          components: { ScrollPane: r.exports },
          data: function() {
            return { visible: !1, top: 0, left: 0, selectedTag: {} };
          },
          computed: {
          ...
          watch: {
            $route: function() {
              this.addViewTags(), this.moveToCurrentTag();
            },
            visible: function(e) {
              e
          ...
          methods: {
            ...
            moveToCurrentTag: function() {
              ...
              this.$nextTick(function() {
                var n = !0,
                  ...
                  o = void 0;
                try {
                  for (var s, r = a()(t); !(n = (s = r.next()).done); n = !0) {
                    var c = s.value;
                    if (c.to.path === e.$route.path) {
                      e.$refs.scrollPane.moveToTarget(c),
                        c.to.fullPath !== e.$route.fullPath &&
                          e.$store.dispatch("updateVisitedView", e.$route);
                      break;
                    }
                  }
                } catch (e) {
            ...
            closeSelectedTag: function(e) {
              var t = this;
              this.$store.dispatch("delView", e).then(function(n) {
                var i = n.visitedViews;
                if (t.isActive(e)) {
                  var a = i.slice(-1)[0];
                  a ? t.$router.push(a) : t.$router.push("/");
                }
              });
            },
            ...
            closeAllTags: function() {
              this.$store.dispatch("delAllViews"), this.$router.push("/");
            },
            openMenu: function(e, t) {
              var n = this.$el.getBoundingClientRect().left,
                i = this.$el.offsetWidth - 105,
                a = t.clientX - n + 15;
              (this.left = a > i ? i : a),
                (this.top = t.clientY),
                (this.visible = !0),
                  ...
                  [
                    n(
                      "li",
                      {
                        on: {
                          click: function(t) {
                            e.refreshSelectedTag(e.selectedTag);
                          }
                        }
                      },
                      [e._v(e._s(e.$t("tagsView.refresh")))]
                    ),
                    e._v(" "),
                    n(
                      "li",
                      {
                        on: {
                          click: function(t) {
                            e.closeSelectedTag(e.selectedTag);
                          }
                        }
                      },
                      [e._v(e._s(e.$t("tagsView.close")))]
                    ),
                    e._v(" "),
                    n("li", { on: { click: e.closeOthersTags } }, [
                      e._v(e._s(e.$t("tagsView.closeOthers")))
                    ]),
                    e._v(" "),
                    n("li", { on: { click: e.closeAllTags } }, [
                      e._v(e._s(e.$t("tagsView.closeAll")))
                    ])
                  ]
                )
              ],
    ...
    MMau: function(e, t, n) {
      ...
      var i = n("QbLZ"),
        ...
        o = n("L2JU"),
        s = {
          components: { SidebarItem: n("6cqe").default },
          computed: a()({}, Object(o.b)(["permission_routers", "sidebar"]), {
            isCollapse: function() {
            ...
            return t(
              ...
              [
                t(
                  ...
                  this._l(this.permission_routers, function(e) {
    ...
    Q2AE: function(e, t, n) {
      ...
      var i = n("Kw5r"),
        ...
        r = {
          state: {
            sidebar: {
              opened: !+s.a.get("sidebarStatus"),
              withoutAnimation: !1
            },
            device: "desktop",
            language: s.a.get("language") || "en",
          ...
          mutations: {
            ...
            SET_LANGUAGE: function(e, t) {
              (e.language = t), s.a.set("language", t);
            },
            SET_SIZE: function(e, t) {
              (e.size = t), s.a.set("size", t);
            }
          },
          actions: {
            ...
            closeSideBar: function(e, t) {
              (0, e.commit)("CLOSE_SIDEBAR", t.withoutAnimation);
            },
            toggleDevice: function(e, t) {
              (0, e.commit)("TOGGLE_DEVICE", t);
            },
            setLanguage: function(e, t) {
              (0, e.commit)("SET_LANGUAGE", t);
            },
            setSize: function(e, t) {
              (0, e.commit)("SET_SIZE", t);
            }
          }
        },
        c = n("4d7F"),
        ...
        h = n("oYx3"),
        m = {
          state: { routers: [], addRouters: [] },
          mutations: {
            SET_ROUTERS: function(e, t) {
              (e.addRouters = t), (e.routers = h.a.concat(t));
            }
          },
          actions: {
            GetUserRouter: function(e) {
              var t = e.commit,
                n = e.state;
              return new l.a(function(e, i) {
                Object(d.c)(n.token)
                  .then(function(n) {
                    var i = n.data.data,
                      a = Object(u.e)(i);
        ...
        V = {
          ...
          mutations: {
            ADD_VISITED_VIEW: function(e, t) {
              e.visitedViews.some(function(e) {
                ...
                e.visitedViews.push(
                  y()({}, t, { title: t.meta.title || "no-name" })
                );
            },
            ...
            DEL_VISITED_VIEW: function(e, t) {
              ...
              try {
                for (
                  var o, s = g()(e.visitedViews.entries());
                  !(n = (o = s.next()).done);
                  n = !0
                ) {
                  var r = o.value,
            ...
            DEL_CACHED_VIEW: function(e, t) {
              ...
              try {
                for (
                  var o, s = g()(e.cachedViews);
                  !(n = (o = s.next()).done);
                  n = !0
                ) {
                  var r = o.value;
                  if (r === t.name) {
                    var c = e.cachedViews.indexOf(r);
              ...
              try {
                for (
                  ...
                  var r = o.value,
                    ...
                    l = c[0];
                  if (c[1].path === t.path) {
                    e.visitedViews = e.visitedViews.slice(l, l + 1);
                    break;
                  }
                }
              } catch (e) {
          ...
          actions: {
            ...
            addVisitedView: function(e, t) {
              (0, e.commit)("ADD_VISITED_VIEW", t);
            },
            addCachedView: function(e, t) {
              (0, e.commit)("ADD_CACHED_VIEW", t);
            },
            delView: function(e, t) {
              ...
              return new l.a(function(e) {
                n("delVisitedView", t),
                  n("delCachedView", t),
                  e({
                    visitedViews: [].concat(p()(i.visitedViews)),
                    cachedViews: [].concat(p()(i.cachedViews))
                  });
              });
            },
            delVisitedView: function(e, t) {
              var n = e.commit,
                i = e.state;
              return new l.a(function(e) {
                n("DEL_VISITED_VIEW", t), e([].concat(p()(i.visitedViews)));
              });
            },
            delCachedView: function(e, t) {
              var n = e.commit,
                i = e.state;
              return new l.a(function(e) {
                n("DEL_CACHED_VIEW", t), e([].concat(p()(i.cachedViews)));
              });
            },
            ...
            delAllVisitedViews: function(e) {
              var t = e.commit,
                n = e.state;
              return new l.a(function(e) {
                t("DEL_ALL_VISITED_VIEWS"), e([].concat(p()(n.visitedViews)));
              });
            },
            delAllCachedViews: function(e) {
              var t = e.commit,
                n = e.state;
              return new l.a(function(e) {
                t("DEL_ALL_CACHED_VIEWS"), e([].concat(p()(n.cachedViews)));
              });
            },
            updateVisitedView: function(e, t) {
              (0, e.commit)("UPDATE_VISITED_VIEW", t);
            }
          }
        },
        z = n("t3Un");
      ...
      var k = {
          ...
          actions: {
            LoginByUsername: function(e, t) {
              var n = e.commit,
                i = t.username.trim();
              return new l.a(function(e, a) {
                (function(e, t) {
                  var n = { username: e, password: t };
                  return Object(z.a)({
            ...
            LogOut: function(e) {
              ...
              return new l.a(function(e, i) {
                (n.token,
                Object(z.a)({ url: "/admin/admin/logout", method: "post" }))
                  .then(function() {
                    t("SET_TOKEN", ""),
                      t("SET_USER", ""),
                      Object(_.b)(),
            ...
            FedLogOut: function(e) {
              var t = e.commit;
              return new l.a(function(e) {
                t("SET_TOKEN", ""), Object(_.b)(), C("user"), e();
              });
            }
          }
        },
        S = {
          ...
          avatar: function(e) {
            return e.user.user.user_avatar;
          },
          name: function(e) {
            return e.user.name;
          },
          introduction: function(e) {
            return e.user.user.introduction;
          },
      ...
      i.default.use(a.a);
      var M = new a.a.Store({
        modules: { app: r, permission: m, tagsView: V, user: k },
        getters: S
      });
      t.a = M;
    },
    ...
    Vtdi: function(e, t, n) {
      ...
      var _ = {
          en: w()(
            {},
            {
              ...
              permission: { roles: "Your roles", switchRoles: "Switch roles" },
              guide: {
                description:
          ...
          zh: w()(
            {},
            {
              ...
              documentation: { documentation: "文档", github: "Github 地址" },
              permission: { roles: "你的权限", switchRoles: "切换权限" },
              guide: {
                description:
              ...
              zip: { export: "导出", placeholder: "请输入文件名(默认file)" },
              theme: {
                change: "换肤",
                documentation: "换肤文档",
                tips:
        ...
        T = new b.a({ locale: c.a.get("language") || "zh", messages: _ }),
        E = {
          name: "SvgIcon",
          props: {
      ...
      C.options.__file = "index.vue";
      var k = C.exports;
      s.default.component("svg-icon", k);
      !(function(e) {
        e.keys().map(e);
      })(n("Uf/o"));
      var S = n("Mj6V"),
      ...
      var L = ["/login", "/auth-redirect"];
      p.b.beforeEach(function(e, t, n) {
        M.a.start(),
          Object(B.a)()
            ? "/login" === e.path
              ? (n({ path: "/" }), M.a.done())
              : (0 === f.a.getters.addRouters.length &&
                  f.a.dispatch("GetUserRouter").then(function() {
                    p.b.addRoutes(f.a.getters.addRouters),
                      n(w()({}, e, { replace: !0 }));
                  }),
                n())
            : -1 !== L.indexOf(e.path)
            ? n()
            : (n("/login?redirect=" + e.path), M.a.done());
      }),
        p.b.afterEach(function() {
          M.a.done();
        });
      var I = n("7Qib");
      function H(e, t) {
        ...
        for (
          ...
          if (e >= n[i].value)
            return (
              (e / n[i].value + 0.1)
                .toFixed(t)
                .replace(/\.0+$|(\.[0-9]*[1-9])0+$/, "$1") + n[i].symbol
            );
        return e.toString();
      }
      function A(e) {
        ...
        s = Object(o.a)(
          ...
          function() {
            ...
            return (this._self._c || e)(
              "component",
              this._b({}, "component", this.linkProps(this.to), !1),
              [this._t("default")],
              2
            );
          },
    ...
    efpO: function(e, t, n) {
      "use strict";
      function i(e) {
        return this.$te("route." + e) ? this.$t("route." + e) : e;
      }
      n.d(t, "a", function() {
        return i;
      });
    ...
    "oQr/": function(e, t, n) {
          ...
          methods: {
            ...
            getBreadcrumb: function() {
              var e = this.$route.params,
                t = this.$route.matched.filter(function(t) {
                  if (t.name) {
                    var n = c.a.compile(t.path);
                    return (t.path = n(e)), !0;
                  }
                }),
                n = t[0];
              n &&
                n.name.trim().toLocaleLowerCase() !==
                ...
                n(
                  ...
                  [
                    ...
                    n(
                      "el-dropdown-item",
                      {
                        attrs: { disabled: "mini" === e.size, command: "mini" }
                      },
                      [e._v("Mini")]
                    )
                  ],
          ...
          function() {
            ...
            return t(
              "el-dropdown",
              {
                ...
                attrs: { trigger: "click" },
                on: { command: this.handleSetLanguage }
              },
              [
                t(
                  "div",
      ...
      var E = T.exports,
        ...
        k = {
          data: function() {
            return { chalk: "", theme: "#409EFF" };
          },
          watch: {
            theme: function(e, t) {
              var n = this;
              if ("string" == typeof e) {
                var i = this.getThemeCluster(e.replace("#", "")),
                  a = this.getThemeCluster(t.replace("#", ""));
                console.log(i, a);
                var o = (function(e, t) {
                  return function() {
                    var a = n.getThemeCluster("#409EFF".replace("#", "")),
                      o = n.updateStyle(n[e], a, i),
                ...
                [].slice
                  ...
                  .filter(function(e) {
                    var n = e.innerText;
                    return (
                      new RegExp(t, "i").test(n) && !/Chalk Variables/.test(n)
                    );
                  })
                  .forEach(function(e) {
                    var t = e.innerText;
                    "string" == typeof t &&
                      (e.innerText = n.updateStyle(t, a, i));
                  }),
          ...
          methods: {
            ...
            getCSSString: function(e, t, n) {
              ...
              (a.onreadystatechange = function() {
                4 === a.readyState &&
                  200 === a.status &&
                  ((i[n] = a.responseText.replace(/@font-face{[^}]+}/, "")),
                  t());
              }),
                a.open("GET", e),
                a.send();
            ...
            getThemeCluster: function(e) {
              for (
                ...
                n.push(t(e, Number((i / 10).toFixed(2))));
              return (
                n.push(
                  (function(e, t) {
                    var n = parseInt(e.slice(0, 2), 16),
      ...
      var M = {
          components: {
            ...
            SizeSelect: z,
            LangSelect: E,
            ThemePicker: S.exports
          },
          computed: a()(
            {},
            Object(o.b)(["sidebar", "name", "avatar", "device"])
          ),
          methods: {
                            ...
                            n("el-dropdown-item", { attrs: { divided: "" } }, [
                              n(
                                "a",
                                {
                                  attrs: {
                                    target: "_blank",
                                    href: "https://github.com/920200256/TVcms"
                                  }
                                },
                                [e._v("\n            GitHub\n          ")]
                              )
                              ...
                              n(
                                "a",
                                {
                                  attrs: {
                                    target: "_blank",
                                    href:
                                      "https://gitee.com/zhuyunlong2018/TVcms"
                                  }
                                },
                                [e._v("\n            码云\n          ")]
                              )
    ...
    oYx3: function(e, t, n) {
      ...
      var s = [
          ...
          children: [
            {
              path: "/redirect/:path*",
              component: function() {
                return n.e("7zzA").then(n.bind(null, "7zzA"));
              }
            }
          ]
        },
        {
          path: "/login",
          component: function() {
            return n.e("chunk-ef1c").then(n.bind(null, "ntYl"));
          },
          hidden: !0
        },
        {
          path: "/auth-redirect",
          component: function() {
            return n.e("JEtC").then(n.bind(null, "JEtC"));
          },
          hidden: !0
        },
        {
          path: "/404",
          component: function() {
            return n.e("chunk-ff37").then(n.bind(null, "/eX4"));
          },
          hidden: !0
        },
        {
          path: "/401",
          component: function() {
            return n.e("chunk-5d30").then(n.bind(null, "UUO+"));
          },
          hidden: !0
        },
        {
          ...
          children: [
            {
              path: "dashboard",
              component: function() {
                return n.e("chunk-8da7").then(n.bind(null, "lAbF"));
              },
              name: "Dashboard",
              meta: { title: "dashboard", icon: "dashboard", noCache: !0 }
            }
          ]
        }
      ];
      ...
      var i = {
          ...
          render: function(e, t) {
            var n = t.props,
              ...
              o = [];
            return (
              i && o.push(e("svg-icon", { attrs: { "icon-class": i } })),
        ...
        a = n("KHd+"),
        o = Object(a.a)(i, void 0, void 0, !1, null, null, null);
      o.options.__file = "Item.vue";
      t.default = o.exports;
    },
    t3Un: function(e, t, n) {
      "use strict";
      var i = n("4d7F"),
        ...
        l = n("X4fA"),
        u = s.a.create({
          baseURL: "http://zhuzu.top/tvcms/public/index.php",
          timeout: 5e3
        });
      u.interceptors.request.use(
        function(e) {
          return (
            c.a.getters.token && (e.headers["X-Api-Token"] = Object(l.a)()), e
          );
        },
        function(e) {
          console.log(e), a.a.reject(e);
        }
      ),
        u.interceptors.response.use(
          ...
          function(e) {
            ...
            var t = "未知错误";
            return (
              void 0 !== e.response.data.msg && (t = e.response.data.msg),
              Object(r.Message)({ message: t, type: "error", duration: 5e3 }),
              10001 === e.response.data.error_code &&
                c.a.dispatch("FedLogOut").then(function() {
                  location.reload();
                }),
              a.a.reject(e)
            );
